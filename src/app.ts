...
import { iCar } from './classes/interfaces.js';
...
class App {
    ...
    questionBodyDesc:Question;
    questionFuelType:Question;
    questionTransmission:Question;
    questionSecurityStatus:Question;
    questionGroupStatus:Question;
    questionCC:Question;
    questionBHP:Question;
    ...
    constructor( data:Array<iCar> ) {
        ...
        this.app = document.querySelector('#app-root') as HTMLDivElement;
    ...
    getCurrentFilter() {
        ...
        const answers = document.querySelectorAll('select') as NodeListOf<HTMLSelectElement>
